...
import type { AssetOperationInput, PortfolioAsset } from '@/app/_types/investments';
import { formatCurrency, formatPercent, calculateAveragePrice } from '@/app/_utils/formatters';
...
export default function DashboardPage() {
  ...
  const handleAddAsset = ({ ticker, name, category, qty, price }: AssetOperationInput) => {
